...
module.exports.run = async (bot, message, args) => {
  ...
  if(message.member.roles.cache.has(bronze.id)) amount = 2600;
  if(message.member.roles.cache.has(silver.id)) amount = 2700;
  if(message.member.roles.cache.has(gold.id)) amount = 2800;
  if(message.member.roles.cache.has(platinum.id)) amount = 2900;
