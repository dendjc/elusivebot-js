...
exports.run = async (client, message, args) => { 
  ...
  if(message.member.roles.cache.has(bronze.id)) amount = 350;
  if(message.member.roles.cache.has(silver.id)) amount = 400;
  if(message.member.roles.cache.has(gold.id)) amount = 450;
  if(message.member.roles.cache.has(platinum.id)) amount = 500;
