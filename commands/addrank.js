exports.run = async (client, message, args) => {
  ...
  if(rank == 1) {
    if(user.roles.cache.has(bronze.id)) return message.channel.send("Taj član već ima Bronze VIP!");
    ...
    if(user.roles.cache.has(silver.id)) return message.channel.send("Taj član već ima Silver VIP!");
    ...
    if(user.roles.cache.has(gold.id)) return message.channel.send("Taj član već ima Gold VIP!");
    if(user.roles.cache.has(bronze.id)) user.roles.remove(bronze);
    if(user.roles.cache.has(silver.id)) user.roles.remove(silver);
    if(user.roles.cache.has(platinum.id)) user.roles.remove(platinum);
    ...
    if(user.roles.cache.has(platinum.id)) return message.channel.send("Taj član već ima Platinum VIP!");
    if(user.roles.cache.has(bronze.id)) user.roles.remove(bronze);
    if(user.roles.cache.has(silver.id)) user.roles.remove(silver);
    if(user.roles.cache.has(gold.id)) user.roles.remove(gold);
